<x-guest-layout>
    <div class="max-w-sm mx-auto">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 text-center">Verify Your Email</h2>
            <p class="text-sm text-gray-600 dark:text-gray-400 text-center mt-2">
                We've sent a 6-digit code to <strong>{{ Auth::user()->email }}</strong>
            </p>
        </div>
