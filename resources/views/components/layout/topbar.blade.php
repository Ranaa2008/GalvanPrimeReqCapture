    ...
    <div class="h-full px-3 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                ...
                <span class="text-lg font-bold text-gray-900 dark:text-white hidden sm:block">GalvanPrimeReqCapture</span>
            </a>
        </div>
        ...
        <div class="flex items-center space-x-1.5">
            ...
            <!-- Notifications -->
            <a href="{{ $notificationLink ?? route('dashboard') }}" class="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 transition relative" aria-label="Unread requirements">
                ...
                @if(($unreadRequirementCount ?? 0) > 0)
                    <span class="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 min-w-[20px] h-5 px-1 text-[11px] leading-none text-white bg-red-500 rounded-full ring-2 ring-white dark:ring-gray-950 grid place-items-center">
                        {{ $unreadRequirementCount > 99 ? '99+' : $unreadRequirementCount }}
                    </span>
                @endif
            </a>
