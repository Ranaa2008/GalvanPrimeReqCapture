...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Requirement</h1>
</div>

<div class="max-w-3xl">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700">
        <form action="{{ route('requirements.store') }}" method="POST" class="p-6" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Add text, record a voice message, and/or upload an attachment.</p>
            </div>
