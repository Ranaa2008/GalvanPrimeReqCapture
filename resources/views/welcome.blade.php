...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>GalvanPrimeReqCapture</title>

        <!-- Fonts -->
        <link rel="preconnect" href="https://fonts.bunny.net">
        <link href="https://fonts.bunny.net/css?family=space-grotesk:400,500,600,700|sora:300,400,500,600&display=swap" rel="stylesheet" />
                ...
                <nav class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex gap-4">
                        ...
                        @else
                            <a
                                href="{{ route('login') }}"
                                class="inline-block px-5 py-2 dark:text-[#EDEDEC] text-[#1b1b18] border border-transparent hover:border-[#19140035] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal"
                            >
                                Log in
                            </a>
                            ...
                            @if (Route::has('register'))
                                <a
                                    href="{{ route('register') }}"
                                    class="inline-block px-6 py-2 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#62605b] dark:hover:border-[#8c8a84] rounded-sm text-sm leading-normal">
                                    Register
                                </a>
                            @endif
                        @endauth
            ...
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none flex items-center justify-center">
                    <div class="text-center max-w-md">
                        <h1 class="text-2xl lg:text-4xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-4">
                            Welcome to GalvanPrimeReqCapture
                        </h1>
                        <p class="text-sm lg:text-base text-[#706f6c] dark:text-[#A1A09A] mb-3 leading-relaxed">
                            Capture project requirements with clarity using text, voice notes, and rich attachments in one secure workspace.
                        </p>
                        <p class="text-sm lg:text-base text-[#706f6c] dark:text-[#A1A09A] leading-relaxed">
                            Keep clients, developers, and leadership aligned with real time status updates, role based access, and traceable delivery history.
                        </p>
                    </div>
                </div>
