...
--
-- Host: localhost
-- Generation Time: May 23, 2026 at 02:44 PM
...
(12, '2026_05_22_090000_create_projects_table', 6),
(13, '2026_05_22_090100_create_project_assignments_tables', 6),
(14, '2026_05_22_090200_create_requirements_table', 6),
(15, '2026_05_23_120000_add_status_notifications_to_requirements_table', 7),
(16, '2026_05_23_130000_add_audio_to_requirements_table', 8),
(17, '2026_05_23_131000_make_requirement_description_nullable', 9),
(18, '2026_05_23_140000_add_voice_to_requirements_table', 10),
(19, '2026_05_23_150000_force_requirement_description_nullable', 11);
...
(32, 'create-projects', 'web', '2026-05-22 13:01:55', '2026-05-22 13:01:55'),
(33, 'view-projects', 'web', '2026-05-22 13:01:55', '2026-05-22 13:01:55'),
(34, 'edit-projects', 'web', '2026-05-22 13:01:55', '2026-05-22 13:01:55'),
(35, 'delete-projects', 'web', '2026-05-22 13:01:55', '2026-05-22 13:01:55'),
(36, 'create-requirements', 'web', '2026-05-22 13:01:55', '2026-05-22 13:01:55'),
(37, 'view-requirements', 'web', '2026-05-22 13:01:55', '2026-05-22 13:01:55'),
(38, 'edit-requirements', 'web', '2026-05-22 13:01:55', '2026-05-22 13:01:55'),
(39, 'delete-requirements', 'web', '2026-05-22 13:01:55', '2026-05-22 13:01:55');
...
(1, 'School System', 'Create a system for a School.', 'Active', 1, '2026-05-22 13:07:11', '2026-05-22 13:07:11'),
(2, 'Catering System', 'Create a system for catering.', 'Active', 1, '2026-05-23 02:49:42', '2026-05-23 02:49:42');
...
INSERT INTO `project_clients` (`id`, `project_id`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 1, 16, NULL, NULL),
(2, 2, 16, NULL, NULL);
...
INSERT INTO `project_developers` (`id`, `project_id`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 1, 17, NULL, NULL),
(2, 2, 17, NULL, NULL);
...
CREATE TABLE `requirements` (
  ...
  `audio_mime` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `voice_path` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `voice_mime` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `status_seen_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `requirements` (`id`, `project_id`, `client_id`, `description`, `audio_path`, `audio_mime`, `voice_path`, `voice_mime`, `status`, `status_updated_at`, `status_updated_by`, `status_seen_at`, `created_at`, `updated_at`) VALUES
(8, 2, 16, 'Add a clr btn.', NULL, NULL, NULL, NULL, 'Read', '2026-05-23 07:35:14', 17, '2026-05-23 08:32:12', '2026-05-23 02:50:47', '2026-05-23 08:32:12'),
(9, 2, 16, 'Put this as the welcome page BG.', 'requirements/48EDRBNkIzFE1HCtPygnv6LMxutlHDx2oVwd7HVU.png', 'image/png', NULL, NULL, 'Read', '2026-05-23 07:34:57', 17, '2026-05-23 08:32:08', '2026-05-23 07:28:09', '2026-05-23 08:32:08');
...
(6, 'Developer', 'web', 4, '2026-05-22 12:26:59', '2026-05-22 12:26:59'),
(7, 'Client', 'web', 4, '2026-05-22 12:26:59', '2026-05-22 12:26:59');
...
(1, 'Mohomed Ruzaik', 'superadmin', 'ranaaruzaik3@gmail.com', 1, NULL, '+94725306373', NULL, 1, NULL, NULL, NULL, '$2y$12$7J6RI5kVURvcSnwHEWjkwuvqccGZMiQKFSCAhCRsGfMSOJUPEvnBS', NULL, NULL, NULL, '2026-05-22 11:56:31', '2026-05-22 11:56:31'),
(16, 'Client', 'client@user', 'client@galvanprime.com', 1, NULL, '+94987654321', NULL, 1, NULL, NULL, NULL, '$2y$12$O9VNogknX/u7uOp5M5DTMeYEbJVVYtn75ez1FbrDhHOL70g.8RBRK', NULL, NULL, 1, '2026-05-22 12:29:28', '2026-05-22 12:31:10'),
(17, 'Developer', 'developer@user', 'dev@galvanprime.com', 1, NULL, '+94123456789', NULL, 1, NULL, NULL, NULL, '$2y$12$SnDW82MUxFz9JjkAQnSVaOyObzFcc9D2Fj/AVmSJuABm4kUDDS.gS', NULL, NULL, 1, '2026-05-22 12:29:30', '2026-05-22 12:31:21');
...
ALTER TABLE `project_clients`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `project_clients_project_id_user_id_unique` (`project_id`,`user_id`),
  ADD KEY `project_clients_user_id_foreign` (`user_id`);
...
ALTER TABLE `project_developers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `project_developers_project_id_user_id_unique` (`project_id`,`user_id`),
  ADD KEY `project_developers_user_id_foreign` (`user_id`);
...
ALTER TABLE `requirements`
  ...
  ADD KEY `requirements_client_id_foreign` (`client_id`),
  ADD KEY `requirements_status_updated_by_foreign` (`status_updated_by`),
  ADD KEY `requirements_status_updated_at_index` (`status_updated_at`),
  ADD KEY `requirements_status_seen_at_index` (`status_seen_at`);
...
ALTER TABLE `project_clients`
  ...
  ADD CONSTRAINT `project_clients_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `project_developers`
  ...
  ADD CONSTRAINT `project_developers_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `requirements`
  ...
  ADD CONSTRAINT `requirements_status_updated_by_foreign` FOREIGN KEY (`status_updated_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
